    ...
    <div className="grid min-h-[calc(100vh-4rem)] md:grid-cols-2">
      <div className="hidden bg-[var(--color-pine-950)] p-12 text-parchment-100 md:flex md:flex-col md:justify-between">
        ...
        <blockquote className="font-display text-3xl leading-snug text-balance">
          "Pack light. We handle the logistics."
        </blockquote>
        <p className="text-sm text-parchment-100/60">Join a community of everyday explorers.</p>
      </div>

      <div className="flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          <h1 className="mb-1 text-3xl font-semibold">Create your account</h1>
          <p className="mb-8 text-sm text-[var(--color-mist-500)]">It takes less than a minute.</p>
          <SignupForm />
        </div>
      </div>
    </div>
